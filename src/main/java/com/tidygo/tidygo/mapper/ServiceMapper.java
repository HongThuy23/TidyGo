...
public interface ServiceMapper {
    ...
    @Mapping(target = "serviceImageResponses", expression = "java(service.getServiceImages() != null ? imageMapper.toImageResponse(service.getServiceImages().getImages()) : null)")
